...
EXPECTED_CSV_FILES: tuple[str, ...] = (
    ...
    "top_skill_taxonomy.csv",
    "skill_taxonomy_summary.csv",
    ...
    *,
    ...
    snapshots: dict[str, dict[str, Any]] = {
        ...
        "top_skills.json": _build_top_skills_snapshot(
            ...
            taxonomy_frame=csv_frames["top_skill_taxonomy.csv"],
            taxonomy_summary_frame=csv_frames["skill_taxonomy_summary.csv"],
...
def _build_top_skills_snapshot(
    *,
    ...
    taxonomy_frame: pd.DataFrame | None,
    taxonomy_summary_frame: pd.DataFrame | None,
    ...
    return {
        ...
        "taxonomy": {
            "summary": _frame_to_records(taxonomy_summary_frame),
            "items": _frame_to_records(taxonomy_frame),
        },
